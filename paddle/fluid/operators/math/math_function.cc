...
template struct SetConstant<platform::CPUDeviceContext, platform::complex<float>>;
template struct SetConstant<platform::CPUDeviceContext, platform::complex<double>>;
...
template struct SetConstant<platform::XPUDeviceContext, platform::complex<float>>;
template struct SetConstant<platform::XPUDeviceContext, platform::complex<double>>;
#endif
...
#define DEFINE_CPU_TRANS(RANK)                                                \
  ...
  template struct Transpose<platform::CPUDeviceContext, platform::complex<float>,  \
                            RANK>;                                            \
  template struct Transpose<platform::CPUDeviceContext, platform::complex<double>, \
                            RANK>;
